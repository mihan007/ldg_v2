    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title custom-modal-title">Создание счета</h3>
            ...
            <div class="modal-body">
                <form class="bill-actions" method="post" action="#" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <div class="invalid-feedback bill-company-invalid-feedback">Сообщение об ошибке</div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="invalid-feedback bill-taxes-invalid-feedback">Сообщение об ошибке</div>
                    </div>
