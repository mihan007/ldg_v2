<div class="row">
    ...
    @desktop
    <div class="col-4 col-sm-4 col-md-6 col-lg-5 text-center mx-auto mb-5 mt-n4">
    ...
    <div class="col-3 col-sm-4 col-md-6 col-lg-6 text-center mr-auto mb-5 mt-n4">
        ...
        <div class="mt-2 alert alert-primary no-data-alert">Нет данных для отображения с учетом текущих настроек фильтра и периода</div>
    </div>
    @enddesktop
</div>
