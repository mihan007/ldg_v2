                    ...
                    <table class="table ad-common-table common-table ad-common-grid" data-offset="187">
                        ...
                        <tr>
                            ...
                            <td class="ad-buttons-col text-center">
                                <a class="btn google-show-button function-button" aria-label="Открыть таблицу детальных настроек"
                                ...
                                <a class="btn google-correct-button function-button"
                                   href=".js-settings-wizard" data-toggle="modal" role="button"
                                   aria-label="Редактировать данные">
                                    <i class="fa fa-pencil" aria-hidden="true"></i>
                                </a>
                                <a class="btn google-reset-button function-button" aria-label="Удалить доступ"
                        ...
                        <tr>
                            ...
                            <td class="ad-buttons-col text-center">
                                <a class="btn google-hide-button function-button" aria-label="Скрыть таблицу детальных настроек"
                                   href="#" role="button" data-toggle="tooltip" data-placement="top"
