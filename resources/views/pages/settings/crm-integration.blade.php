...
@section('content')
    <main class="page-wrapper">
        <h1 class="sr-only">Страница настроек "Интеграция с CRM"</h1>
        <div class="row sticky-top bg-white">
            ...
            <div class="col-md-12 settings-wrapper font-weight-bold">
                ...
                @include('includes.settings-links', ['step'=>'crm-integration'])
                <div>
                ...
                <div class="orders-source-table-wrapper mb-5">
                    <table class="table orders-source-table common-table orders-source-grid" data-offset="110">
                        ...
                        <tr>
                            <td class="activity-col text-center">
                                <div class="custom-control custom-switch">
                                    <input class="custom-control-input custom-control-input-success" id="crm-active-switch"
                                           type="checkbox" checked>
                                    <label class="custom-control-label" for="crm-active-switch"
                            ...
                            <th class="source-col text-center">Битрикс 24</th>
                            <td class="data-connect-col text-center">
                                <form class="order-source-copy-form" method="post" action="/">
                                    <div class="input-group">
                                        <input class="form-control copy-form-input" type="text" id="crm-copy-form-input"
                                               value="https://name.bitrix24.ru/rest/1/7k5lak0lsn91ln/">
                            ...
                            <td class="source-buttons-col text-center">
                                <a class="btn crm-integration-correct-button function-button"
                                   href=".js-settings-wizard" data-toggle="modal" role="button" aria-label="Редактировать
                                   данные">
                                    <i class="fa fa-pencil" aria-hidden="true"></i>
                                </a>
                                <a class="btn crm-integration-reset-button function-button" aria-label="Удалить доступ"
                        ...
                        <tr>
                            <td class="activity-col text-center">
                                <div class="custom-control custom-switch">
                                    <input class="custom-control-input custom-control-input-success" id="crm-active-switch2"
                                           type="checkbox">
                                    <label class="custom-control-label font-italic" for="crm-active-switch2"
                                           aria-label="Активность включена/выключена"></label>
                                </div>
                            </td>
                            ...
                            <td class="text-center">
                                <form class="order-source-copy-form" method="get" action="/">
                                    <div class="input-group">
                                        <input class="form-control copy-form-input" type="text" id="crm-copy-form-input2"
                                               value="https://name.bitrix24.ru/rest/1/7k5lak0lsn91ln/">
                                        <div class="input-group-append">
                                            <button class="btn btn-secondary copy-button" type="button"
                            ...
                            <td class="text-center">
                                <a class="btn crm-integration-correct-button function-button" data-toggle="modal"
